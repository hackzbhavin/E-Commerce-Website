...
<form  class="form-inline" action="admin_home.php"  method="post" enctype="multipart/form-data">
    <h5 style='allign-text:center'>Hello <?php echo $_SESSION['a_fname']; ?> </h1>
      <input style='width:100%; align:center' class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name='se'>
      <button style='width:50%; align:center' class="btn btn-outline-success my-2 my-sm-0" name="filter" type="submit">Search</button>
</form>
<br>
