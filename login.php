	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			header("Location: afterlogin/u_home.php"); // Redirect user to index.php
                ...
                $_SESSION["error"] = $error; # error after wrong credentials
               ?>
...
<div style='float:right'>
    <img src="img_logos/fg2.gif" style='width:200px ;height: 150px;'>
</div>
<div class='login_div'>
...
<a href="registration.php"><button class="register_btn" type="button"> Back to SignUp</button></a>
</div>
</div>
</form>
</div>
